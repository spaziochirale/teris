/*
  ...
  Sketch per la definizione del device di controllo dell'impianto presso Holycon
...
/* Definizione dell'impianto
  ...
  Due inverter tradizionali vecchio modello SofarTrad 40Kw
  Un inverter trifase ZCS di tipo nuovo
  
  !!! VERIFICARE GLI INDIRIZZI MODBUS ASSEGNATI !!!
  
*/
#define INVERTER_TRAD1 1
#define INVERTER_TRAD2 2
#define INVERTER_ZCS 3
...
*/
SofarTrad40KwFrequentDataCollection(INVERTER_TRAD1);
SofarTrad40KwAlert(INVERTER_TRAD1);
SofarTrad40KwFrequentDataCollection(INVERTER_TRAD2);
SofarTrad40KwAlert(INVERTER_TRAD2);
ZCSTrifaseDayLightFrequentDataCollection(INVERTER_ZCS); // mancando il RTC viene sempre effettuata questa lettura anche di notte
ZCSTrifaseFrequentDataCollection(INVERTER_ZCS);
